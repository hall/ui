...
export class EnvironmentService {
  ...
  public list() {
    return this.http.get(`${environment.server}/environments`)
    .pipe(
  ...
  public available(env: string, start: Date, end: Date) {
    ...
    return this.http.post(`${environment.server}/environments/${env}/available`, params)
    .pipe(
      map((s: ServerResponse) => JSON.parse(atob(s.content))),
  ...
  public add(env: Environment) {
    ...
    return this.http.post(`${environment.server}/environments`, params)
  }
